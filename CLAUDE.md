...
A documentation-only repository. There are no build steps, test suites, or code to run. The primary artifact is `AGENT-BLUEPRINT.md` — a framework-agnostic checklist for building reliable agentic systems.

## Document Structure

`AGENT-BLUEPRINT.md` is organized around **four problems** that every agentic system must solve:
...
1. Copy the Project Checklist block at the bottom of `AGENT-BLUEPRINT.md` into a new project's documentation.
